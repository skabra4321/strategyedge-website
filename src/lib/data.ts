export const capabilities = [
  {
    ...
    icon: 'compass',
    summary:
      'Corporate and business unit strategy, operating model design, organisational restructuring, and large-scale transformation programmes for governments and enterprises.',
    description:
  ...
  },
  {
    ...
    shortTitle: 'Procurement & Supply Chain',
    icon: 'link',
    summary:
      'Strategic sourcing, procurement operating model transformation, supply chain resilience, and national content compliance for organisations operating at sovereign scale.',
    description:
  ...
  },
  {
    ...
    icon: 'bar-chart',
    summary:
      'Finance function redesign, management reporting architecture, budgeting and planning transformation, treasury strategy, and CFO advisory for complex multi-entity structures.',
    description:
  ...
  },
  {
    ...
    icon: 'settings',
    summary:
      'Operating model optimisation, performance management, lean transformation, and process redesign for industrial, infrastructure, and service organisations.',
    description:
  ...
  },
  {
    ...
    icon: 'leaf',
    summary:
      'Sustainability strategy, ESG governance frameworks, reporting architecture, and transition roadmaps aligned to GCC national mandates and global investor expectations.',
    description:
  ...
  },
  {
    slug: 'pmo-execution',
    title: 'PMO & Execution',
    shortTitle: 'PMO & Execution',
    icon: 'target',
    summary:
      'Transformation programme design, PMO establishment, benefit realisation tracking, and execution governance for national and enterprise-scale programmes.',
    description:
  ...
  {
    slug: 'expert-secondments',
    title: 'Expert Secondments',
    shortTitle: 'Expert Secondments',
    icon: 'users',
    summary:
      'We embed senior practitioners directly into client organisations -- as interim functional leads, transformation anchors, or programme directors -- for mandates where sustained senior presence is the requirement.',
    description:
...
export const industries = [
  {
    ...
    summary:
      'Strategic advisory for ministries, government authorities, and public institutions leading national transformation programmes.',
  },
  {
    slug: 'sovereign',
    title: 'Sovereign & State-Linked Organisations',
    summary:
      'Transformation advisory for sovereign wealth funds, state-owned enterprises, and entities operating under national mandates.',
  },
  {
    slug: 'energy',
    title: 'Energy & Utilities',
    summary:
      "Strategy and operational transformation for the energy companies and utilities at the centre of the GCC's economic diversification.",
  },
  {
    slug: 'industrial',
    title: 'Industrial & Manufacturing',
    summary:
      'Operations, procurement, and strategy for industrial conglomerates, manufacturers, and the national champions driving Vision programme delivery.',
  },
  {
    slug: 'infrastructure',
    title: 'Infrastructure & Real Estate',
    summary:
      "Programme governance, procurement strategy, and transformation support for the region's landmark infrastructure and real estate development programmes.",
  },
  {
    slug: 'mobility',
    title: 'Mobility & Logistics',
    summary:
      'Strategy, operations, and supply chain transformation for the transport, logistics, and mobility organisations connecting the GCC economy.',
  },
  {
    slug: 'technology',
    title: 'Technology & Digital',
    summary:
      'Digital strategy, operating model design, and technology transformation for technology-led organisations and digital business units within traditional enterprises.',
  },
]
...
export const leadershipTeam = [
  {
    slug: 'managing-principal',
    name: 'Khalid Al-Rashidi',
    title: 'Founding & Managing Principal',
    former: ['BCG', 'Strategy&'],
    focus: ['Corporate Strategy', 'Government Advisory', 'Operating Model Design'],
    bio: 'Khalid founded StrategyEdge after a decade at BCG and Strategy&, where he led major strategy and transformation engagements for GCC governments and sovereign-linked organisations. He has advised ministers, sovereign fund boards, and industrial group CEOs on strategy, restructuring, and national programme delivery.',
    linkedin: '#',
  },
  {
    slug: 'principal-finance',
    name: 'Sara Al-Mansoori',
    title: 'Principal, Finance & Transformation',
    former: ['McKinsey', 'PwC'],
    focus: ['Finance Transformation', 'CFO Advisory', 'Capital Markets'],
    bio: "Sara leads StrategyEdge's finance transformation and secondment practice. Prior to joining the firm, she spent twelve years at McKinsey and PwC advising GCC CFOs on finance function transformation, treasury strategy, and capital structure. She has served as interim CFO on three secondment mandates across the industrial and sovereign sectors.",
    linkedin: '#',
  },
  {
    slug: 'principal-operations',
    name: 'Nasser Al-Qhtani',
    title: 'Principal, Operations & Procurement',
    former: ['Kearney', 'Roland Berger'],
    focus: ['Procurement Transformation', 'Operations Excellence', 'Supply Chain'],
    bio: "Nasser leads the firm's procurement and operations practice with particular depth in the industrial, energy, and infrastructure sectors. His career at Kearney and Roland Berger included landmark procurement transformation programmes for national energy companies and government procurement authorities across Saudi Arabia, UAE, and Qatar.",
    linkedin: '#',
  },
]
...
export const insights = [
  {
    ...
    readTime: '8 min read',
    summary:
      'Most organisations treat national content requirements as a regulatory obligation to be managed around. The most sophisticated ones are using them to build structural competitive advantage.',
    author: 'Nasser Al-Qhtani',
  },
  {
    slug: 'gc-cfo-agenda-2026',
    title: 'The GCC CFO Agenda in 2026: Three Irreversible Shifts',
    category: 'Finance',
    date: 'April 2026',
    readTime: '10 min read',
    summary:
      'Consolidation pressure, capital allocation complexity, and the ESG reporting imperative are redefining what it means to lead a finance function in the GCC. A practical view from inside the mandate.',
  ...
  },
  {
    ...
    readTime: '6 min read',
    summary:
      'The economics of global consulting firms create a structural conflict between the seniority you buy and the seniority you receive. Here is what you should ask before the next engagement begins.',
  ...
  },
  {
    ...
    readTime: '7 min read',
    summary:
      'There is a category of transformation challenge that advisory engagements cannot solve. Understanding when to shift from a consulting model to an embedded one is one of the most important decisions a transformation leader can make.',
    author: 'Khalid Al-Rashidi',
  },
]

export const metrics = [
  { value: '$6B+', label: 'Value of mandates\nsupported across the GCC' },
  { value: '15+', label: 'Average years of senior\nexperience per principal' },
